const localesTextarea = document.getElementById('locales');
const dishesTextarea = document.getElementById('dishes');
const ordersTextarea = document.getElementById('orders');

updateLineNumbers(localesTextarea);
updateLineNumbers(dishesTextarea);
updateLineNumbers(ordersTextarea);
